...
### Data Analyses with Code
R: This [page](https://josh-myers.github.io/R_Ordinal_Analysis.html) presents an analysis in which I developed an ordinal model for diagnosing middle ear disease for my PhD project (Myers et al., 2018c).

Python: This [page](https://josh-myers.github.io/Py_PetFinder.html) shows an analysis that I did in Python for a Kaggle competition.
...
### Publications
Below are articles I have published or am in the process of publishing in scientific journals. 
