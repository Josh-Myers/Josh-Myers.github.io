...
### Web applications 
[This app](https://joshmyers.shinyapps.io/WAIPredictions/) implements the predictive models that I developed during my PhD project (Myers et al. 2018a, 2018b, 2019a, 2019b, 2019c). It allows the user to query a model with a subject's test result by either uploading an XML file saved from a clinical device, or entering the values for the model variables directly. 
